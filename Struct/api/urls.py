...
from .views import UserRegistrationView, LoginView, ClassCreateView, JoinClassView, UserClassesView, UserLogView, UserProgressView
...
urlpatterns = [
    ...
    path('user-progress/', UserProgressView.as_view(), name='user-progress'),  # Assuming you have a UserProgressView
